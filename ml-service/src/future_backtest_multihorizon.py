...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Backtest multi-horizon dedicated forecast models on unseen future years.")
...
def main() -> None:
    ...
    output_path = PROCESSED_DIR / "future_backtest_multihorizon_results.csv"
    ...
    if not results_frame.empty:
        ...
        print(f"Saved multi-horizon backtest results to {output_path}")
